...
public class Lab_6 {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Step 1: Login (Register first if needed)
            registerAndLogin();
            ...
            // Step 5: Click on 'Add to cart' for first item
            addFirstItemToCart();
            
            // Step 6: Click on 'Specification' tab
            clickSpecificationTab();
            
            // Step 7: Verify details on page
            verifyDetailsOnPage();
            ...
            // Step 10: Enter 'Mobile' in search box
            searchForMobile();
            
            // Step 11: Click on Search button
            clickSearchButton();
            
            // Step 12: Check 'Search in product descriptions'
            checkSearchInDescriptions();
            
            // Step 13: Click on link 'HTC Touch HD'
            clickHTCTouchHD();
            ...
            // Step 17: Click on 'View cart' button
            viewCart();
            
            // Step 18: Verify Mobile name added to cart
            verifyMobileInCart();
            
            // Step 19: Click on 'Checkout' button
            clickCheckout();
            
            // Step 20: Click on 'My Account' dropdown
            clickMyAccountDropdown();
            
            // Step 21: Select 'Logout' from dropdown
            selectLogout();
    ...
    private static void clickSpecificationTab() throws InterruptedException {
        ...
        // Navigate to first product if not already there
        try {
            driver.findElement(By.xpath("//a[@href='#tab-specification']"));
        } catch (Exception e) {
            // Not on product page, navigate to first product
