...
public class Lab_8_testng {
    ...
    @Test(priority = 1, description = "Automates the basic flow from Lab 3")
    ...
    @Test(priority = 2, description = "Automates the validation flow from Lab 4")
