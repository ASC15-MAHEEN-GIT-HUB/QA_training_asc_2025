...
public class Lab_5 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("input-email")).sendKeys("QA_Train@gmail.com");
 
		driver.findElement(By.id("input-telephone")).sendKeys("8878787878");
 
		driver.findElement(By.xpath("//input[@type='submit' and @value='Continue']")).click();
		
		driver.findElement(By.id("input-password")).sendKeys("QAUser@1234");
		
		driver.findElement(By.id("input-confirm")).sendKeys("QAUser1@1234");
